cd('/Volumes/Fenrir/State_dep/EC_State')
sess_list = dir;
sess_list(1:2) = [];
main_dir = cd;


good_sess_list = {'M13_2018_12_09',...
    'M13_2018_12_11',...
    'M13_2018_12_16',...
    'M13_2018_12_17',...
    'M14_2018_12_01',...
...
for iSess =30:length(sess_list); % made it to 30
    if iSess  == 2211% || iSess = 9
        continue
    else
        if ~strcmp(sess_list(iSess).name(1:3), 'M16')  && ~strcmp(sess_list(iSess).name(1:3), 'M17')
